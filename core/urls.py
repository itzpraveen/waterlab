...
urlpatterns = [
    ...
    path('samples/<uuid:pk>/metadata/', SampleReportMetadataUpdateView.as_view(), name='sample_report_metadata'),
    ...
    path('ai-settings/', AISettingsUpdateView.as_view(), name='ai_settings'),
